...
export CUSTOM_BRAND__ENABLED${CUSTOM_BRAND__ENABLED:=false}
export CUSTOM_BRAND__NAME${CUSTOM_BRAND__NAME:="Mattermost"}
export CUSTOM_BRAND__TEXT${CUSTOM_BRAND__TEXT:=""}
export CUSTOM_BRAND__DESCRIPTION${CUSTOM_BRAND__DESCRIPTION:=""}
...
export EMAIL_SETTINGS__BUTTON_COLOR=${EMAIL_SETTINGS__BUTTON_COLOR:="#000"}
export EMAIL_SETTINGS__BUTTON_BORDER_COLOR=${EMAIL_SETTINGS__BUTTON_BORDER_COLOR:="#0032db"}
export EMAIL_SETTINGS__BUTTON_TEXT_COLOR=${EMAIL_SETTINGS__BUTTON_TEXT_COLOR:="#0032db"}
...
export CUSTOM_EMOJI_ENABLE=${CUSTOM_EMOJI_ENABLE:=true}
export ENABLE_EMOJI_PICKER=${ENABLE_EMOJI_PICKER:=true}

export THREADS_AUTOFOLLOW=${THREADS_AUTOFOLLOW:=false}
export THREADS_COLLAPSED=${THREADS_COLLAPSED:="disabled"}
